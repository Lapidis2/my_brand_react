          ...
          <div className="insights">
            <div className="insights-header">
              ...
              <span>
                ...
                insights, and the future of software innovation .
              </span>
            </div>
            <div>
              {loading && (
              ...
              {!loading && (<div className="insights-main" id="ii">
              {blogsData.map((item, index) => {
                return (
                  <div className="insight-card">
                    <Link to={`/single-blog/${item._id}`} className="picture" style={{ cursor: "pointer" }}>
